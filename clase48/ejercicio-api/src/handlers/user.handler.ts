...
export const createUser = async (ctx: Context) => {
    try {
        ...
        logger.debug(
            `status: ${ctx.response.status} method: createUser handler`
        );
...
export const updateUser = async (ctx: Context) => {
    try {
        ...
        logger.debug(
            `status: ${ctx.response.status} method: updateUser handler`
        );
...
export const deleteUser = async (ctx: Context) => {
    try {
        ctx.response.status = 200;
        logger.debug(
            `status: ${ctx.response.status} method: deleteUser handler`
        );
